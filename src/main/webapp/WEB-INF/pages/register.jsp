                    ...
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                              ...
                              <form id="mainForm" role="form" action="${context}/user" method="post" class="login-form">
			                    	<div class="form-group">
			                    		<label class="sr-only" for="email">Email</label>
			                        	<input type="text" name="email" id ="email" placeholder="Email..." class="form-control" style="min-width: 100%"">
			                        </div>
			                        <div class="form-group">
			                    		<label class="sr-only" for="Name">Name</label>
			                        	<input type="text" name="fullname" id ="fullname" placeholder="Name..." class="form-control" style="min-width: 100%">
			                        </div>
			                        <div class="form-group">
			                        	<label class="sr-only" for="password">Password</label>
			                        	<input type="password" name="password" id="password" placeholder="Password..." class="form-control" style="min-width: 100%" >
			                        </div>
			                        <div class="form-group">
			                        	<label class="sr-only" for="Confirm password">Confirm Password</label>
			                        	<input type="password" name="password2"  id="password2" placeholder="Confirm Password..." class="form-control" style="min-width: 100%" >
			                        </div>
			                        <button type="submit" class="btn" id="signInBtn">Register!</button>
